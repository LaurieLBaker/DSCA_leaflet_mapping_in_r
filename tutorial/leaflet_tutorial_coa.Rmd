...
# Customizing your plot: colors and labels
...
* What other color palettes can you create using `colorBin()`?
...
### Adding labels to the GPS map as popups

- Before you run the code. What do you expect the labels will look like? 
...
```{r access admin 0 boundaries for nigeria and chad, fig.alt="Map of Nigeria and Chad: admin level 0."}
...
# Try further customizing your Nigeria plot with the color palette you created
