...
subtitle: "College of the Atlantic Training"
...
* Create a new variable using `mutate` which calculates how many births above or below the average counties are. Choose a palette that will be best to show this. 
* Create a new map with the births from 1979
* Change around the different visual elements of the plots. 
* Create a new set of labels for the leaflet map with points.
* Check out the short tutorial on joins. 
