...
```{r, echo = FALSE, out.width=550, fig.align='center', fig.cap="Map of U.S. Counties showing green blue colour scheme"}
...
.right-plot[
```{r first-leaflet-map1g, ref.label='first-leaflet-map1g', echo=FALSE, out.width="95%"}
```
...
```{r work-leaflet, ref.label='work-leaflet', echo=FALSE, out.width="100%"}
```
...
```{r work-leaflet1, ref.label='work-leaflet1', echo=FALSE, out.width="100%"}
```
...
.font150.text-white[
Special thanks to Rich Leyshon at the Data Science Campus
]
