...
* Looking for US data? Check out [Different ways of plotting the U.S. map](https://jtr13.github.io/cc19/different-ways-of-plotting-u-s-map-in-r.html)
...
nigeria_pop <- nigeria_pop %>%
  mutate(ADM1_NAME = str_to_title(ADM1_NAME, locale = "en")) # Make names Title Case
